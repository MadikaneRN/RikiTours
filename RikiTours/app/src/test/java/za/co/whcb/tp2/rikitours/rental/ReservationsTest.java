...
public class ReservationsTest {
    ...
    public void setUp() throws Exception {
        reservations = ReservationsFactory.getReservations("10/10/2016","15/10/2016","cape Town","Mini bus",customer);
    }

    @Test
    public void testReservations() throws Exception {
        Assert.assertNotNull(reservations);
        Assert.assertEquals(reservations.getVehicleType(),"Mini bus");
    }

...
public class ItenaryTest {
    ...
    public void testCreate() throws Exception {
       /* ArrayList<Attraction> attractions = new ArrayList<>();
        ...
        AttractionDescription description2 = AttractionDescriptionFactory.getAttractionDescription("shaun", "two", "three", "four");
        Attraction attraction2 = AttractionFactory.getAttraction(country2, description2);

...
public class EventsDescriptionTest extends AndroidTestCase{
    ...
    public void addEventsDesciptionTest() {
        ...
        assertEquals(true, eventDescriptionRepo.addEventDescription(eventsDescription));
    }

    public void findCountryById() {
        EventsDescription eventsDescription = eventDescriptionRepo.findEventDescriptionById(1L);
